...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $tid = $_POST["tid"];
    $sql="SELECT name FROM `teacher` WHERE id='$tid'";
    ...
    $query = "insert into course (cname,cid,department,section,tname,tid,Room,ctimestart,ctimeend) values ('$coursename','$courseid','$department','$section','$teachername','$tid','$classroom','$ctimes','$ctimee')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="Course.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Course</a>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-6">
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <form action="" method="POST">
                                ...
                                <input type="text" id="fname" name="coursename" required><br><br>
                                <label for="lname">Course ID:</label>
                                <input type="text" id="lname" name="courseid" required><br><br>
                                ...
                                <input type="text" id="lname" name="tid" required><br><br>
                                <label for="tname">Class Room:</label>
                                <input type="text" id="tname" name="croom" required><br><br>
                                <label for="tname">Class Time Start:</label>
                                <input type="time" id="tname" name="ctimes" required><br><br>
                                <label for="tname">Class Time End:</label>
                                <input type="time" id="tname" name="ctimee" required><br><br>
                    ...
                    <div class="col-sm-12 ">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table table-dark">
                                ...
                                <?php
                                $s = "Select distinct(cid),cname,department from course  ";

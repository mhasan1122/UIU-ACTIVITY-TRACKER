...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "insert into teacher (name,id,department,email,number,password,dob,gender,profession) values ('$name','$id','$department','$email','$number','$md5pass','$birthdaytime','$gender','$profession')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="teacher.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Teacher</a>
                        ...
                        <div class="h-100 bg-secondary rounded p-4">
                            ...
                            <form action="" method="POST">
                                ...
                                <option value="" disabled selected>Choose option</option>
                                    <option value="Professor & Vice Chancellor">Professor & Vice Chancellor</option>
                                    <option value="Professor & Pro-Vice Chancellor">Professor & Pro-Vice Chancellor</option>

                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="card mt-3">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <h6 class="mb-0" style="color:black"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-linkedin mr-2 icon-inline">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                   <a href=""> <?php echo $row['project_link']; ?></a>
                                </div>
                            </div>
                            <br>
                            <div class="row">

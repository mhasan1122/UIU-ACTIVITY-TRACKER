...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["submit"])) {
        ...
        $description= $_POST['description'];
            ...
            $sql="UPDATE `experience` SET `title`='$title',`companyname`='$company',`description`='$description' WHERE id='$id'";
                        ...
                        <br>
                                        ...
                                        <form autocomplete="off" action="" method="post">
                                            <div class="px-4 mt-1">
                                                ...
                                                <br>
                                                <input style="width:300px;height:50px; border:3px solid #FFA500;" type="text" id="tite" name="title" value="<?php echo $title ?>">
                                                ...
                                                <br>
                                                <input style="width:300px;height:50px; border:3px solid #FFA500;" type="text" id="company" name="company"value="<?php echo $company ?>">
                                                <br>
                                                ...
                                                <br>
                                                <textarea style="width:300px;height:150px;border:3px solid #FFA500;" type="text" id="description" name="description"> <?php echo $description ?></textarea>
                                                <br>

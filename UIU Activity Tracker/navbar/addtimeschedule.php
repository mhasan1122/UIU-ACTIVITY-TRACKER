...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['starttime'] = $_POST['start'];
    $_SESSION['endtime'] = $_POST['end'];
    if (!empty($_POST['day'])) {
        $_SESSION['day'] = $_POST['day'];
    }
    header("location:addtimeapi.php");
}
            ...
            <div class="col-md-7">
                ...
                <div class="card p-3 py-4">
                    ...
                    <div class="text-center">
                        <img src="uploads/<?= $_SESSION['teacher_image'] ?>" width="100" class="rounded-circle">
                    </div>
                        ...
                        <form action="" method="post">
                            <div class="px-4 mt-1">
                                ...
                                <select name="day" id="day">
                                    ...
                                    <option value="Tuesyday">Tuesyday</option>

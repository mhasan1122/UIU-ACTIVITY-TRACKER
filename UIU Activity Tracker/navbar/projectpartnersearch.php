...
<body>
  ...
  <table class="table table-dark">
    ...
    $s = "Select * from student where id like '%$sid%'";
    ...
    ?>
      <tbody>
        <tr>
          ...
          <?php echo "<td> <a href='addpartner.php?id=$id&name=$name&proid=$idz'><button type='button' class='btn btn-primary'>ADD</button> </a></td>" ?>
        </tr>
